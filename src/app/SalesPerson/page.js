...
import {
  CreateBuilderForm,
  getbuilderList,
} from "@/redux/action/builder-action.js/builder-action";
...
export default function SalesPerson() {
  ...
  const [CreateNewBuilderModalIsOpen, setCreateNewBuilderModalIsOpen] =
    useState(false);
  ...
  const table = useMaterialReactTable({
    ...
    renderTopToolbarCustomActions: ({ table }) => (
      ...
      >
        <Button
          onClick={() => BuilderopenModal("create")}
          startIcon={<AddIcon />}
  ...
  return (
    <>
      ...
      >
        ...
        >
          <h2 style={{ margin: "0", color: "#63C2C7" }}>Create New Builder</h2>
          <div
            style={{ cursor: "pointer", color: "red" }}
            onClick={BuildercloseModal}
          >
            <ImCross />
          </div>
        </div>

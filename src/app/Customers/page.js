...
import { CreatecustomerForm, getcustomerList } from "@/redux/action/customers-action.js/customers-action";
...
export default function Customers() {
    ...
    const [CreateNewCustomersModalIsOpen, setCreateNewCustomersModalIsOpen] = useState(false);
    ...
    const data = useMemo(() => customerlist?.customers ?? [], [customerlist?.customers]);
    ...
    const table = useMaterialReactTable({
        ...
        renderTopToolbarCustomActions: ({ table }) => (
            <Box sx={{ display: "flex", gap: "16px", padding: "8px", flexWrap: "wrap" }}>
                <Button onClick={() => CustomersopenModal("create")} startIcon={<AddIcon />} style={{ color: theme.colors._63C2C7 }}>
                    Create Customer
                </Button>
            </Box>
        ),
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <div style={{ cursor: "pointer", color: "red" }} onClick={CustomerscloseModal}>
                        <ImCross />
                    </div>
                </div>
